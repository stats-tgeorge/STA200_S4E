...
listing:
  ...
  field-display-names:
    name: "Howework Due"
    custom-field: "Custom"
  fields: [title,date,description,Homework Due]
---
...
**Note**: The timeline of topics and assignments might be updated throughout the block. 
...
<!-- # library(tidyverse) -->
<!-- # gs4_deauth() -->
<!-- # d <- read_sheet("https://docs.google.com/spreadsheets/d/1taVhpqgTIzaj0ztxFWnj5l4JCRvrF6Ml2eo4ry8EyL4/edit?usp=sharing") -->
<!-- # ``` -->
...
<!--           Activity = activity, Homework = HW,Outline = outline,Exam = exam, -->
<!--          Project = project) |> -->
