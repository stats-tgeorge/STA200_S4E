...
Some ideas: Brochure, Comics, Children's Book, Poster/infographic, Video/tik tok, Inforgraphic. 

## Deliverables and Due Dates

1)    Mid Block Presentation - Due Thursday, September 4th at 9am. Practice in Class.

2)    Present Mid Block Presentation - Friday September 5th at 9am.

3a)   Final visual with presentation - Due Friday September 12th at 9am. Practice in class. 

  Submit by placing PDF or image file of your final visual in group Google Drive folder. Extension to Friday 9/12 at 11:59pm. 
  
3b)   Full Draft of Analysis Report - Due Friday September 12th at 11:59pm.

  Submit at [THIS LINK](https://moodle.cornellcollege.edu/mod/assign/view.php?id=338264) on Moodle.
  
4)    Final Presentation to Waypoint - Monday September 15th

5)    SYS Showcase - Tuesday September 16th

6)    Final Analysis report - Due Wednesday September 17th at 11:59 am via Google Doc link on [Moodle](https://moodle.cornellcollege.edu/mod/assign/view.php?id=339796).
...
Of those XX were successfully housed. 

Evaluation on demographics of those served (age, gender, race, etc) .

### Group 2

How many individuals served demonstrated housing instability by reaching back out to Waypoint for additional housing support? Looking to see if they attempted to reconnect with Waypoint post program exit.  


### Group 3

Evaluate differences between those who were stably housed vs those who were not? 

Of the individuals successfully housed,  were there any episodes of criminal activity/charges post-housing achievement? 

### Group 4

Of individuals who did not achieve housing stability, were there any episodes of criminal activity/charges after contact/referral to Waypoint?

If so, what was the amount of time that lapsed before the criminal activity/charge occurred? 
...
Any other observations or correlations gleaned from the data? 
...
Including all of the items in your presentation. Use Google Slides saved in your group folder. Export the slides as PDF and submit them to Moodle immediately following the presentation Friday September 8th. I am asking your group to present for about 6-8 minutes total.
...
I am asking your group to present for about 5-8 minutes total.
...
### Full Draft of Analysis Reports

At first submission, you should have all components of the report included; however, your paper may not be as polished. I will evaluate you across the same areas, but the total points are 50. Generally, I will be more forgiving and leave comments, but not always take off points during the first submission round. Our Learning Assistant will also review your paper to provide feedback, but will not be involved in the grading process. 


+-----------------------+------------------+-----------------+
|                       | First Submission | Final Submission|
+=======================+==================+=================+
| Total                 | 50 pts           | 150 pts         |
+-----------------------+------------------+-----------------+
| 1.  Title             | 2.5 pts          | 7.5 pts         |
+-----------------------+------------------+-----------------+
| 2.  Background        | 10 pts           | 30 pts          |
+-----------------------+------------------+-----------------+
| 3.  Methods           | 10 pts           | 30 pts          |
+-----------------------+------------------+-----------------+
| 4.  Results           | 10 pts           | 30 pts          |
+-----------------------+------------------+-----------------+
| 5.  Conclusions       | 7.5 pts          | 22.5 pts        |
+-----------------------+------------------+-----------------+
| 6.  References        | 5 pts            | 15 pts          |
+-----------------------+------------------+-----------------+
| 7.  Technical Quality | 5 pts            | 15 pts          |
+-----------------------+------------------+-----------------+

Submit Full Draft at [THIS LINK](https://moodle.cornellcollege.edu/mod/assign/view.php?id=338264) on Moodle. 

Submit Final Draft at [THIS LINK](https://moodle.cornellcollege.edu/mod/assign/view.php?id=339796) on Moodle. 
...
| Aesthetics                                                        | 25 pts      |
+-------------------------------------------------------------------+-------------+
| Correctness of Statistical Analysis and Interpretation            | 25 pts      |
+-------------------------------------------------------------------+-------------+
| Information Delivery (writing and graphs match intended audience) | 25 pts      |
+-------------------------------------------------------------------+-------------+
| Connects literature and current research                          | 25 pts      |
+-------------------------------------------------------------------+-------------+
