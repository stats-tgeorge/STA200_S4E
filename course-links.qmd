...
| Gradebook                  | 🔗 on [Moodle]({{< var course.mgradebook >}}) |
| Minitab                    | 🔗 on [Minitab](https://app.minitab.com)                 |

## Other Useful Links
-   [Discussion Norms](/course-materials/documents/teamcontracttemplate.docx)
...
-   [Introduction to `feasts` R package](https://cran.r-project.org/web/packages/feasts/vignettes/feasts.html)
